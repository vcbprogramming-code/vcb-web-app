...
export interface OrgTeamBranch {
  id: string;
  label: string;
  members: OrgPerson[];
  offsite?: boolean;
...
export interface OrgTeamBranches {
  id: string;
  label: string;
  branches: OrgTeamBranch[];
}
...
export interface Project {
  ...
  label: string;
  lead: OrgPerson;
  opsDepartments: ProjectDept[];
  adminDepartments: ProjectDept[];
}
...
export interface GroupJointVenture {
  id: string;
  label: string;
  parents: string[];
}
...
export interface GroupStructure {
  ...
  parent: GroupEntity;
  familyCompanies: GroupEntity[];
  subsidiaries: GroupEntity[];
  jvs: GroupJointVenture[];
}
...
export const DEPARTMENTS_ORG: (OrgTeam | OrgTeamBranches)[] = [
  {
    id: "engineering",
...
export const ADMINISTRATION: OrgTeam = {
  id: "administration",
...
// exists in this app.
const opsDepartments: ProjectDept[] = [
  {
...
const adminDepartments: ProjectDept[] = [
  {
    label: "Maintenance",
...
export const PROJECT_MANAGERS: ProjectManagers = {
  id: "pm",
...
export const GROUP_STRUCTURE: GroupStructure = {
