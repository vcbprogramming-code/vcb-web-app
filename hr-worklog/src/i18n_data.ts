...
export const T: Record<string, { en?: string }> = {
  ...
  'เพิ่มโครงการใหม่ หรือปิดโครงการที่จบแล้ว · โครงการที่ปิดจะไม่ให้บันทึกงานใหม่ แต่ประวัติเดิมยังอยู่ในแดชบอร์ด': { en: 'Add a new project, or close a finished one · closed projects accept no new entries but keep their history on the dashboard' },
  ...
  'จะไม่สามารถบันทึกงานใหม่ได้ แต่ประวัติเดิมยังอยู่': { en: 'No new entries can be logged, but existing history is kept.' },
