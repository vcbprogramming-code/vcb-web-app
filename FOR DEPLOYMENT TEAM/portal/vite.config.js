...
// @vcb/shared is a sibling folder, not an installed package. `preserveSymlinks:
// false` plus an explicit alias means Vite resolves its .jsx sources through
// this app's own React copy — two Reacts would break every hook.
