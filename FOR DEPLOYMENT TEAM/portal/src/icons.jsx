...
//
// Sizing used to come from CSS descendant rules (`.sidebar-logo svg { width:
// 21px }`). With those gone, every icon takes a className instead, so the call
// site decides — which also means an icon can be reused at a different size
// without a new rule.

/** The size almost every call site wants; override via className. */
...
export function AnnouncementIcon({ className = ICON }) {
  return (
    <svg {...svgProps} className={className}>
...
export function HelpIcon({ className = ICON }) {
  return (
    <svg {...svgProps} className={className}>
      <circle cx="12" cy="12" r="9" />
...
export function OnboardingIcon({ className = ICON }) {
  return (
    <svg {...svgProps} className={className}>
...
export function ErpIcon({ className = ICON }) {
  return (
    <svg {...svgProps} className={className}>
...
export function ZoomIcon({ className = ICON }) {
  return (
    <svg {...svgProps} className={className}>
...
export function AiTavernIcon({ className = ICON }) {
  return (
    <svg {...svgProps} className={className}>
...
export function DashboardIcon({ className = ICON }) {
  return (
    <svg {...svgProps} className={className}>
...
export function NavArrowIcon({ className = 'h-3.5 w-3.5' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function AppIcon({ icon, className = ICON }) {
  switch (icon) {
    case 'memo':
      return (
        <svg {...svgProps} className={className}>
