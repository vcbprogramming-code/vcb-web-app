// Single-color line icons (Lucide-style), drawn with currentColor so they
// tint with the surrounding text. Use <Icon name="..." className="w-5 h-5" />.
...
const PATHS = {
  ...
  signature: (
    <>
      <path d="M3 17c3 0 3-9 6-9s2 7 5 7 3-4 5-4" />
      <path d="M3 21h18" />
    </>
  ),
  download: (
