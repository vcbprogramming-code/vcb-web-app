...
export const api: ServerApi = {
  ...
  setProjectPublic: (id, p, t) => delay(() => mockApi.setProjectPublic(id, p, t)),
  addProjectViewer: (id, e, t) => delay(() => mockApi.addProjectViewer(id, e, t)),
  addProjectViewers: (id, e, t) => delay(() => mockApi.addProjectViewers(id, e, t)),
  removeProjectViewer: (id, e, t) => delay(() => mockApi.removeProjectViewer(id, e, t)),
  copyProjectViewers: (from, to, t) => delay(() => mockApi.copyProjectViewers(from, to, t)),
  getEditors: (t) => delay(() => mockApi.getEditors(t)),
  addEditor: (e, t) => delay(() => mockApi.addEditor(e, t)),
  removeEditor: (e, t) => delay(() => mockApi.removeEditor(e, t)),
  getEditorAccounts: (t) => delay(() => mockApi.getEditorAccounts(t)),
  setEditorPassword: (e, p, t) => delay(() => mockApi.setEditorPassword(e, p, t)),
  editorLogin: (e, p) => delay(() => mockApi.editorLogin(e, p)),
  getSharedPinStatus: (t, r) => delay(() => mockApi.getSharedPinStatus(t, r)),
  setSharedEditorPin: (p, t) => delay(() => mockApi.setSharedEditorPin(p, t)),
  clearSharedEditorPin: (t) => delay(() => mockApi.clearSharedEditorPin(t)),
