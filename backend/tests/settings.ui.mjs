...
suite('2. หน้าตั้งค่ารวมอยู่ที่เดียว');
{
  ...
  for (const s of ['โปรไฟล์และลายเซ็น', 'ผู้ใช้และสังกัดโครงการ', 'สิทธิ์การใช้งาน', 'ประกาศ', 'โครงการ / หัวจดหมาย', 'บริษัท / ตรา', 'ประเภทเอกสาร', 'ผู้อนุมัติตามรหัสเอกสาร']) {
  ...
  bad('ผู้ใช้ทั่วไปไม่เห็นเมนูของผู้ดูแล', !th.includes('สิทธิ์การใช้งาน') && !th.includes('ประเภทเอกสาร'), '');
