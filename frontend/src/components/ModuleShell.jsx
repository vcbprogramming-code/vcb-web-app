          ...
          <div className="relative flex shrink-0 items-center" ref={menuRef}>
            ...
            {menuOpen && (
              <div role="menu" className="absolute right-0 top-full z-40 mt-2 w-56 overflow-hidden rounded-2xl border border-slate-200 bg-white py-1.5 shadow-xl">
                ...
                >
                  <Icon name="user" className="h-4 w-4 text-slate-400" /> {t('โปรไฟล์และลายเซ็น')}
                </button>
                <button
                  onClick={toggle}
                  className="flex w-full items-center gap-2.5 px-4 py-2.5 text-left text-sm text-slate-700 transition hover:bg-slate-50"
                ...
                <button
                  ...
                  title={t('ออกจากระบบแล้วเข้าด้วยบัญชีอื่น โดยกลับมาที่หน้านี้')}
                  className="flex w-full items-center gap-2.5 px-4 py-2.5 text-left text-sm text-slate-700 transition hover:bg-slate-50"
                >
                  <Icon name="people" className="h-4 w-4 text-slate-400" /> {t('สลับบัญชี')}
                </button>
                <button
                ...
                >
                  <Icon name="logout" className="h-4 w-4" /> {t('ออกจากระบบ')}
                </button>
              </div>
            )}
          </div>
