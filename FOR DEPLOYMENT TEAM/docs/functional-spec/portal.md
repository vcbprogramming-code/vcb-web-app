...
9. **แหล่งข้อมูลที่ถูกต้องของโมดูลนี้** — ใช้เอกสารฉบับนี้, `PORT_NOTES.md` และซอร์สโค้ดจริง
   เป็นหลักเสมอ `README.md` ในโฟลเดอร์ `portal/` เป็นเพียงคำแนะนำการรันแบบสั้น ๆ
