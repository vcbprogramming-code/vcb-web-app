...
// Pure-CSS 3D globe — decorative only, markup ported verbatim from index.html's
// .globe-card / .globe-stage. No mission tooltip, no click-to-open behavior,
// no hover text swapping — just the animated sphere visual.
