...
export const dictionary = createDictionary({
  ...
  'editor.underline': { th: 'ขีดเส้นใต้', en: 'Underline' },
  ...
  'history.deleteEntry': { th: 'ลบรายการนี้', en: 'Delete this entry' },
  'history.deleteEntryTitle': { th: 'ลบรายการประวัตินี้?', en: 'Delete this history entry?' },
  'history.deleteVersion': { th: 'ลบสำเนานี้', en: 'Delete this snapshot' },
  'history.deleteVersionTitle': { th: 'ลบสำเนาฉบับนี้?', en: 'Delete this saved snapshot?' },
  'history.clearAll': { th: 'ล้างประวัติทั้งหมด', en: 'Clear all history' },
  'history.clearAllTitle': {
    th: 'ล้างประวัติการแก้ไขทั้งหมดของการประชุมนี้?',
    en: "Clear this meeting's entire edit history?",
  },
  'history.clearAllHint': {
    th: 'ลบทั้งรายการกิจกรรมและสำเนาที่บันทึกไว้ทั้งหมด แก้ไขคืนไม่ได้',
    en: 'Removes every activity entry and saved snapshot. This cannot be undone.',
  },
