...
export default function SettingsModal({ s }: { s: Store }) {
  ...
  // Delegates to copyText, which races the Clipboard API against a short
  // timeout so a hung permission prompt (observed inside Apps Script's
  // sandboxed iframe in the canonical app) can't freeze the button/page.
  function copyEmail() {
